...
const Leaderboard = () => {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      case 'Mid-Level': return 'bg-blue-50 text-blue-700 border-blue-200';
      case 'Intermediate': return 'bg-blue-50 text-blue-700 border-blue-200'; // legacy
      case 'Junior': return 'bg-amber-50 text-amber-700 border-amber-200';
      case 'Beginner': return 'bg-amber-50 text-amber-700 border-amber-200'; // legacy
      case 'Entry': return 'bg-gray-50 text-gray-700 border-gray-200';
