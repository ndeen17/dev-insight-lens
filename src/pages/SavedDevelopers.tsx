  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="bg-white border-b border-gray-200 py-6">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link 
              to="/browse"
              className="flex items-center justify-center space-x-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-green-400 text-black rounded-full hover:bg-green-500 active:scale-[0.97] transition-all font-bold text-sm sm:text-base whitespace-nowrap"
            >
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        {savedDevs.length === 0 ? (
          <div className="text-center bg-white rounded-2xl shadow-sm border border-gray-200 p-16 animate-fade-in-up">
            <div className="w-20 h-20 rounded-2xl bg-gray-100 flex items-center justify-center mx-auto mb-6 animate-float">
              <Inbox className="w-10 h-10 text-gray-400" />
            </div>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">No Saved Developers Yet</h2>
            <p className="text-sm text-gray-500 mb-8 max-w-sm mx-auto">
              Start browsing developers and swipe right to save them here!
            </p>
            <Link 
              to="/browse"
              className="inline-flex items-center space-x-2 px-8 py-3 bg-green-400 text-black rounded-full hover:bg-green-500 active:scale-[0.97] transition-all font-bold"
            >
            ...
            {savedDevs.map((dev) => (
              ...
              >
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 p-6 text-white">
                  ...
                  <p className="text-green-100 text-sm">@{dev.username}</p>
                  {dev.location && (
                    <p className="text-green-100 text-xs mt-1 flex items-center gap-1"><MapPin className="w-3 h-3" /> {dev.location}</p>
                  )}
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div className="bg-green-50 rounded-lg p-3 border-2 border-green-100">
                      <div className="text-xl font-bold text-green-600">{dev.level}</div>
                      <div className="text-xs text-gray-600">Level</div>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3 border-2 border-green-100">
                      <div className="text-xl font-bold text-green-600">{dev.score}</div>
                  ...
                  <div className="flex gap-2">
                    <a 
                      ...
                      className="flex-1 flex items-center justify-center space-x-1 px-4 py-2 bg-green-400 text-black rounded-lg hover:bg-green-500 active:scale-[0.97] transition-all text-sm font-bold"
                    >
