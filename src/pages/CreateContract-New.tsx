...
import { Calendar, DollarSign, Clock, Plus, Trash2, AlertCircle, ArrowLeft, Check, Save } from 'lucide-react';
...
export default function CreateContract() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showDraftToast && (
        <div className="fixed top-4 right-4 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2 animate-in slide-in-from-top">
      ...
      <header className="bg-white border-b border-gray-200 px-8 py-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Artemis</h1>
              <p className="text-sm text-gray-600">Contract Creation</p>
            </div>
          </div>
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center flex-1">
                ...
                {index < steps.length - 1 && (
                  <div className={`h-1 flex-1 -mt-8 transition-all ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
                ...
                {currentStep === 1 && (
                  <>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Define the basic details and enter the freelancer's email — we'll send them an invite to collaborate.
                    </p>
                  </>
                )}
                {currentStep === 2 && (
              ...
              {/* Payment Summary - Only show on step 3 */}
              {currentStep === 3 && (
                <Card>
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-xs text-gray-500 pt-4 border-t">
                      Payment will be held in escrow until milestones are approved.
                    </div>
                  </CardContent>
                </Card>
              )}
              ...
              <CardContent className="p-8">
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    <div>
                      <Label htmlFor="contractName" className="text-sm font-medium text-gray-700 mb-2">
                        Contract Name *
                      </Label>
                      <div className="relative">
                        <Input
                          ...
                          maxLength={70}
                          className={`py-3 ${errors.contractName ? 'border-red-500' : 'border-gray-300'}`}
                        />
                    ...
                    <div>
                      <Label htmlFor="contributorEmail" className="text-sm font-medium text-gray-700 mb-2">
                        Freelancer's Email *
                      </Label>
                      <Input
                        id="contributorEmail"
                        ...
                        className={`py-3 ${errors.contributorEmail ? 'border-red-500' : 'border-gray-300'}`}
                      />
                    ...
                    <div>
                      ...
                      <RadioGroup value={contractType} onValueChange={(value: 'fixed' | 'hourly') => setContractType(value)}>
                        ...
                        <div className="flex items-center space-x-2 p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                          ...
                          <Label htmlFor="hourly" className="font-normal cursor-pointer flex items-center gap-2">
                    ...
                    {contractType === 'fixed' ? (
                      <>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="budget" className="text-sm font-medium text-gray-700 mb-2">
                              Budget *
                            </Label>
                            <Input
                              id="budget"
                              ...
                              min="0"
                              step="0.01"
                              className={`py-3 ${errors.budget ? 'border-red-500' : 'border-gray-300'}`}
                            />
                            {errors.budget && (
                          ...
                          <div>
                            <Label htmlFor="currency" className="text-sm font-medium text-gray-700 mb-2">
                              Currency
                            </Label>
                        ...
                        <div className="flex items-center space-x-2 p-4 border rounded-lg bg-gray-50">
                          ...
                          <Label htmlFor="splitMilestones" className="font-normal cursor-pointer">
                            Split project into milestones for incremental payments
                          </Label>
                        </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                              {milestones.map((milestone, index) => (
                                <div key={index} className="grid grid-cols-12 gap-2 items-start border p-4 rounded-lg bg-gray-50">
                      ...
                      <>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="hourlyRate" className="text-sm font-medium text-gray-700 mb-2">
                              Hourly Rate *
                            </Label>
                            <Input
                              id="hourlyRate"
                              ...
                              min="0"
                              step="0.01"
                              className={`py-3 ${errors.hourlyRate ? 'border-red-500' : 'border-gray-300'}`}
                            />
                            {errors.hourlyRate && (
                        ...
                        <div>
                          <Label htmlFor="weeklyLimit" className="text-sm font-medium text-gray-700 mb-2">
                            Weekly Hour Limit
                          </Label>
                          <Input
                            id="weeklyLimit"
                            ...
                            min="0"
                            disabled={noLimit}
                            className={`py-3 ${errors.weeklyLimit ? 'border-red-500' : 'border-gray-300'}`}
                          />
                          {errors.weeklyLimit && (
                ...
                <div className="flex justify-between pt-8 border-t mt-8">
                  ...
                  <div className="flex gap-2">
                    {currentStep < 3 ? (
                      <Button onClick={handleNext} className="px-8 bg-blue-600 hover:bg-blue-700">
                        Next
                      </Button>
                    ) : (
